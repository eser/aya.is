      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className={`flex items-center justify-center p-1.5 text-muted-foreground hover:text-foreground transition-colors rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ${copied ? "text-green-600" : ""}`}
