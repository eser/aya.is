...
} from "@/modules/navigation/navigation-context";
import {
  EasterEgg,
  ResponsiveIndicator,
} from "@/components/page-layouts/default";
import {
  supportedLocales,
  DEFAULT_LOCALE,
  ...
  return (
    <I18nextProvider i18n={i18n}>
      <NavigationProvider state={navigationState}>
        <RootDocument locale={navigationState.locale} dir={navigationState.localeData.dir}>
          <AuthProvider>
