  ...
  return (
    <html lang={locale} dir={dir} className={ssrThemeClass} suppressHydrationWarning>
      ...
      <body className="min-h-screen bg-background font-sans antialiased">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:z-50 focus:top-4 focus:left-4 focus:bg-background focus:text-foreground focus:px-4 focus:py-2 focus:rounded-md focus:shadow-md"
        >
          Skip to content
        </a>
        {children}
