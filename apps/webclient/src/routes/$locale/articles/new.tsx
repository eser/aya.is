...
export const Route = createFileRoute("/$locale/articles/new")({
...
function NewArticlePage() {
  ...
  const handleSave = async (data: ContentEditorData) => {
    ...
    if (result !== null) {
      toast.success(t("Articles.Article created successfully"));
      navigate({
      ...
      toast.error(t("Articles.Failed to create article"));
    }
  };
    ...
    <PageLayout>
      <div className="h-[calc(100vh-140px)]">
        <ContentEditor
          ...
          backUrl={`/${params.locale}/articles`}
