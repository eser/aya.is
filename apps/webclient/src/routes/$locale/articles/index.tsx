...
export const Route = createFileRoute("/$locale/articles/")({
  ...
  loader: async ({ params, context }) => {
    ...
    await Promise.all([
      context.queryClient.ensureQueryData(storiesByKindsQueryOptions(locale, ["article"])),
...
function ArticlesPage() {
  ...
  const { data: articles } = useSuspenseQuery(storiesByKindsQueryOptions(locale, ["article"]));
