...
export default function ProfileLinksPage() {
  ...
  useEffect(() => {
    const loadLinks = async () => {
      try {
        ...
        setError(
          t("Profile", "Failed to load profile links") ??
  ...
  const onSubmit = async (data: LinkFormData) => {
    ...
    try {
      if (editingLink) {
        ...
        const updatedLink = await backend.updateProfileLink(
          localeCode,
          slug,
          editingLink.id,
          {
        ...
        setSuccessMessage(
          t("Profile", "Link updated successfully") ??
        ...
        setSuccessMessage(
          t("Profile", "Link created successfully") ??
  ...
  const handleDelete = async (linkId: string) => {
    ...
    try {
      ...
      setSuccessMessage(
        t("Profile", "Link deleted successfully") ??
          "Link deleted successfully",
      );
    } catch (error) {
      console.error("Failed to delete link:", error);
      setError(
        t("Profile", "Failed to delete link") ?? "Failed to delete link",
      );
    }
  };
      ...
      <Card>
        <CardHeader>
          <div className={styles.cardHeaderWithAction}>
            <div>
              <CardTitle>
                {t("Profile", "Current Links") ?? "Current Links"}
              </CardTitle>
              <CardDescription>
                {t(
                  "Profile",
              ...
              >
                    ...
                    <FormItem>
                      ...
                      >
                        <FormControl>
                          <SelectTrigger>
                            <SelectValue
                              placeholder={t("Profile", "Select link type") ??
                                "Select link type"}
                            />
                          </SelectTrigger>
                        </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("Profile", "Display Title") ?? "Display Title"} *
                      </FormLabel>
                      <FormControl>
                        <Input
                          placeholder={t(
                            "Profile",
                            "How this link should appear",
                          ) ?? "How this link should appear"}
                          {...field}
                        />
                      </FormControl>
