...
const generalSettingsSchema = z.object({
  title: z.string().min(2, "Title must be at least 2 characters").max(
    100,
  ...
  pronouns: z.string().max(50, "Pronouns must be no more than 50 characters")
    .optional(),
});
...
export default function ProfileSettingsPage() {
  ...
  useEffect(() => {
    const loadProfile = async () => {
      try {
        ...
        setError(
          t("Profile", "Failed to load profile data") ??
  ...
  const onSubmit = async (data: GeneralSettingsFormData) => {
    ...
    try {
      ...
      setError(
        t("Profile", "Failed to update profile") ?? "Failed to update profile",
      );
    } finally {
  ...
  const handleProfilePictureUpdate = async (newProfilePictureURI: string) => {
    try {
      ...
      if (newProfilePictureURI === "") {
        setSuccessMessage(
          t("Profile", "Profile picture removed successfully") ??
            "Profile picture removed successfully",
        );
      } else {
        setSuccessMessage(
          t("Profile", "Profile picture updated successfully") ??
      ...
      setError(
        t("Profile", "Failed to update profile picture") ??
    ...
    <div className={styles.container}>
      ...
      <div className={styles.forms}>
        ...
        <Card>
          <CardHeader>
            <CardTitle>
              {t("Profile", "Basic Information") ?? "Basic Information"}
            </CardTitle>
            <CardDescription>
              {t(
                "Profile",
        ...
        <Card>
          <CardHeader>
            <CardTitle>
              {t("Profile", "Profile Information") || "Profile Information"}
            </CardTitle>
            <CardDescription>
              {t(
                "Profile",
