...
export function localeMatchFromRequest(
  ...
  if (localeQueryParam !== null) {
    return {
      origin: "queryParam",
      localeCode: localeMatch([localeQueryParam], supportedLocales)?.code ??
        defaultLocaleCode,
      updateCookie: true,
    };
  }
  ...
  if (localeCookie !== undefined) {
    return {
      origin: "cookie",
      localeCode: localeMatch([localeCookie.value], supportedLocales)?.code ??
        defaultLocaleCode,
      updateCookie: false,
    };
  }
  ...
  if (localeHeader !== null) {
    ...
    return {
      origin: "header",
      localeCode: localeMatch(locales, supportedLocales)?.code ??
        defaultLocaleCode,
      updateCookie: true,
    };
  }
